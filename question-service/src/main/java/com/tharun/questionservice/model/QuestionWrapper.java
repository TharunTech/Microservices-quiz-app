package com.tharun.questionservice.model;

public class QuestionWrapper {//class used to store the questions and display only nessary details, when the quiz is called
